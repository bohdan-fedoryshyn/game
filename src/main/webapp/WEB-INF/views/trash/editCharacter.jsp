...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <%--<a href="/admin/control/character" class="nav-item nav-link">Clear</a>--%>
            <%--</div>--%>
            <%--<div class="navbar-nav">--%>
...
<div class="my-margin d-flex justify-content-center">
    <form:form class="row g-3 align-items-center" method="post" modelAttribute="character">
        <div class="col-auto">
        ...
        <div class="col-sm-12">
            <table class="table table-dark" width="">
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            <a href="/admin/control/character/delete/${character.name}">
